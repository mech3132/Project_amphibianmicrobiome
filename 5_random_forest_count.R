...
dir.create("5_random_forest_count")
...
if ( RERUN_RF ) {
  ...
  # save(RF_infect_PA, file="./5_random_forest_count/RF_infect_PA.RData")
  
}

# temp <- extractError(RF_infect_PA, bd_type="infect",otu_type="PA",error_type = "R2", replicates=c(1:10), prop_levels=0.7)
# temp %>%
#   gather(onlyp, nop, withp, key="model", value="R2") %>%
#   ggplot() +geom_point(aes(x=model, y=R2, col=type))

# RF_infect_PA_0.8TEMP <- RF_infect_PA
...
if ( RERUN_RF ) {
  ...
  save(RF_PABD_10_1,file="./5_random_forest_count/RF_PABD_10_1.RData" )
  ...
  # save(RF_PABD_PA, file="./5_random_forest_count/RF_PABD_PA.RData")
}

RELOAD_RAW <- FALSE
if ( RELOAD_RAW ) {
  load("./5_random_forest_count/RF_infect_10_1.RData")
  load("./5_random_forest_count/RF_infect_10_2.RData")
  load("./5_random_forest_count/RF_infect_10_3.RData")
  load("./5_random_forest_count/RF_infect_10_4.RData")
  load("./5_random_forest_count/RF_infect_10_5.RData")
  load("./5_random_forest_count/RF_infect_10_6.RData")
  
  load("./5_random_forest_count/RF_PABD_10_1.RData")
  load("./5_random_forest_count/RF_PABD_10_2.RData")
  load("./5_random_forest_count/RF_PABD_10_3.RData")
  load("./5_random_forest_count/RF_PABD_10_4.RData")
  load("./5_random_forest_count/RF_PABD_10_5.RData")
  load("./5_random_forest_count/RF_PABD_10_6.RData")
  #### Infect extract #####
  # infect_test_train_comparison_ponly <- extractItem(allOutput = list(RF_infect_10_1, RF_infect_10_2, RF_infect_10_3), bd_type="infect", otu_type = "count", p_types="onlyp", reps=c(1:10)
  #                                                   , extract="test_train_comparison")
  # infect_test_train_comparison_ponly2 <- extractItem(allOutput = list(RF_infect_10_4, RF_infect_10_5, RF_infect_10_6), bd_type="infect", otu_type = "count", p_types="onlyp", reps=c(1:10)
  #                                                    , extract="test_train_comparison", repstart=31)
  # save(infect_test_train_comparison_ponly, file="./5_random_forest_count/infect_test_train_comparison_ponly.RData")
  # save(infect_test_train_comparison_ponly2, file="./5_random_forest_count/infect_test_train_comparison_ponly2.RData")
  # 
  infect_test_train_comparison_nop <- extractItem(allOutput = list(RF_infect_10_1, RF_infect_10_2, RF_infect_10_3), bd_type="infect", otu_type = "count", p_types="nop", reps=c(1:10)
                                                  , extract="test_train_comparison")
  infect_test_train_comparison_nop2 <- extractItem(allOutput = list(RF_infect_10_4, RF_infect_10_5, RF_infect_10_6), bd_type="infect", otu_type = "count", p_types="nop", reps=c(1:10)
                                                   , extract="test_train_comparison", repstart=31)
  save(infect_test_train_comparison_nop, file="./5_random_forest_count/infect_test_train_comparison_nop.RData")
  save(infect_test_train_comparison_nop2, file="./5_random_forest_count/infect_test_train_comparison_nop2.RData")
  
  infect_test_train_comparison_withp <- extractItem(allOutput = list(RF_infect_10_1, RF_infect_10_2, RF_infect_10_3), bd_type="infect", otu_type = "count", p_types="withp", reps=c(1:10)
                                                    , extract="test_train_comparison")
  infect_test_train_comparison_withp2 <- extractItem(allOutput = list(RF_infect_10_4, RF_infect_10_5, RF_infect_10_6), bd_type="infect", otu_type = "count", p_types="withp", reps=c(1:10)
                                                     , extract="test_train_comparison", repstart=31)
  save(infect_test_train_comparison_withp, file="./5_random_forest_count/infect_test_train_comparison_withp.RData")
  save(infect_test_train_comparison_withp2, file="./5_random_forest_count/infect_test_train_comparison_withp2.RData")
  # 
  # # Getting importance
  # importance_ponly <- extractItem(allOutput = list(RF_infect_10_1, RF_infect_10_2, RF_infect_10_3), bd_type="infect", otu_type = "count", p_types="onlyp", reps=c(1:10)
  #                                 , extract="importance")
  # importance_ponly2 <- extractItem(allOutput = list(RF_infect_10_4, RF_infect_10_5, RF_infect_10_6), bd_type="infect", otu_type = "count", p_types="onlyp", reps=c(1:10)
  #                                  , extract="importance", repstart=31)
  # save(importance_ponly, file="./5_random_forest_count/importance_ponly.RData")
  # save(importance_ponly2, file="./5_random_forest_count/importance_ponly2.RData")
  # 
  
  
  #### PABD extract####
  # PABD_test_train_comparison_ponly <- extractItem(allOutput = list(RF_PABD_10_1, RF_PABD_10_2, RF_PABD_10_3), bd_type="PABD", otu_type = "count", p_types="onlyp", reps=c(1:10)
  #                                                 , extract="test_train_comparison")
  # PABD_test_train_comparison_ponly2 <- extractItem(allOutput = list(RF_PABD_10_4, RF_PABD_10_5, RF_PABD_10_6), bd_type="PABD", otu_type = "count", p_types="onlyp", reps=c(1:10)
  #                                                  , extract="test_train_comparison", repstart=31)
  # save(PABD_test_train_comparison_ponly, file="./5_random_forest_count/PABD_test_train_comparison_ponly.RData")
  # save(PABD_test_train_comparison_ponly2, file="./5_random_forest_count/PABD_test_train_comparison_ponly2.RData")
  # 
  PABD_test_train_comparison_nop <- extractItem(allOutput = list(RF_PABD_10_1, RF_PABD_10_2, RF_PABD_10_3), bd_type="PABD", otu_type = "count", p_types="nop", reps=c(1:10)
                                                , extract="test_train_comparison")
  PABD_test_train_comparison_nop2 <- extractItem(allOutput = list(RF_PABD_10_4, RF_PABD_10_5, RF_PABD_10_6), bd_type="PABD", otu_type = "count", p_types="nop", reps=c(1:10)
                                                 , extract="test_train_comparison", repstart=31)
  save(PABD_test_train_comparison_nop, file="./5_random_forest_count/PABD_test_train_comparison_nop.RData")
  save(PABD_test_train_comparison_nop2, file="./5_random_forest_count/PABD_test_train_comparison_nop2.RData")
  
  PABD_test_train_comparison_withp <- extractItem(allOutput = list(RF_PABD_10_1, RF_PABD_10_2, RF_PABD_10_3), bd_type="PABD", otu_type = "count", p_types="withp", reps=c(1:10)
                                                  , extract="test_train_comparison")
  PABD_test_train_comparison_withp2 <- extractItem(allOutput = list(RF_PABD_10_4, RF_PABD_10_5, RF_PABD_10_6), bd_type="PABD", otu_type = "count", p_types="withp", reps=c(1:10)
                                                   , extract="test_train_comparison", repstart=31)
  save(PABD_test_train_comparison_withp, file="./5_random_forest_count/PABD_test_train_comparison_withp.RData")
  save(PABD_test_train_comparison_withp2, file="./5_random_forest_count/PABD_test_train_comparison_withp2.RData")
  # 
  # # Getting importance
  # importance_ponly_PABD <- extractItem(allOutput = list(RF_PABD_10_1, RF_PABD_10_2, RF_PABD_10_3), bd_type="PABD", otu_type = "count", p_types="onlyp", reps=c(1:10)
  #                                      , extract="importance")
  # importance_ponly_PABD2 <- extractItem(allOutput = list(RF_PABD_10_4, RF_PABD_10_5, RF_PABD_10_6), bd_type="PABD", otu_type = "count", p_types="onlyp", reps=c(1:10)
  #                                       , extract="importance", repstart=31)
  # save(importance_ponly_PABD, file="./5_random_forest_count/importance_ponly_PABD.RData")
  # save(importance_ponly_PABD2, file="./5_random_forest_count/importance_ponly_PABD2.RData")
  # 
...
rbind(cbind(infect_test_train_comparison_nop, model="nop")
...
#### PABD plot ####
rbind(cbind(PABD_test_train_comparison_nop, model="nop")
