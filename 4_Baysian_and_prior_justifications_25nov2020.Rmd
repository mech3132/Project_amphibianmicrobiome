---
title: "4_Baysian_and_prior_justifications"
...
RERUN_DIST = TRUE
RERUN_DISP = TRUE
RERUN_PERCINHIB = TRUE
RERUN_INHIBRICH = TRUE
...
```{r shannonI_process, results="hide"}
...
```{r disperBCI_process, results="hide"}
...
```{r disperUWUI_process, results="hide"}
...
```{r disperWUI_process, results="hide"}
##### Dispersion (WU) (I) #######
...
```{r distBCI_process, results="hide"}
##### Distance (BC) (I) #######
...
```{r distUWUI_process, results="hide"}
##### Distance (UWU) (I) #######
...
```{r distWUI_process, results="hide"}
##### Distance (WU) (I) #######
if ( RERUN_DIST ) {
...
```{r percInhibI_process, results="hide"}
...
```{r inhibRichI_process, results="hide"}
...
```{r alphaobservedII_process, results="hide"}
...
```{r alphachao1II_process, results="hide"}
##### RICHNESS (Chao1) (II) #######
...
```{r alphaShannonII_process, results="hide"}
...
```{r alphaFaithII_process, results="hide"}
...
```{r disperBCII_process, results="hide"}
...
```{r disperUWUII_process, results="hide"}
...
```{r disperWUII_process, results="hide"}
...
```{r distBCII_process, results="hide"}
...
```{r distUWUII_process, results="hide"} 
...
```{r distWUII_process, results="hide"}
...
```{r percRichII_process, results="hide"}
...
```{r inhibRichII_process, results="hide"}
